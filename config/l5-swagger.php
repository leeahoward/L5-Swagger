...
return [
    ...
    */
    ...
    /* 
    |--------------------------------------------------------------------------
    | Should we use laravel filesystems api to store files?
    | if set, then you also need to set the filesystems_api_disk to use
    | and be sure configure the disk in your laravel filesystems config
    | if false will use the path.docs location specified above
    |--------------------------------------------------------------------------
    */
    'use_filesystems_api' => env('L5_USE_FILESYSTEMS_API', false),
    'filesystems_api_disk' => env('L5_FILESYSTEMS_API_DISK', 'l5swagger'),

    /*
    |--------------------------------------------------------------------------
    | use the defined routes to generate the docs
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | additional parameters for filtering output
    |--------------------------------------------------------------------------
    */
    'api_group_filter' => env('L5_SWAGGER_GROUP_FILTER'),
    'api_name_filter' => env('L5_SWAGGER_NAME_FILTER'),
    'api_path_filter' => env('L5_SWAGGER_PATH_FILTER'),
    'api_method_filter' => env('L5_SWAGGER_METHOD_FILTER'),
    'api_sort_reverse' =>env('L5_SWAGGER_SORT_REVERSE'),
    'api_sort' => env('L5_SWAGGER_API_SORT'), 

    /*
    |--------------------------------------------------------------------------
    | template swagger.json file. 
    | Contains the default meta for your swagger docs
    | default file generated by running artisan l5swagger:publish_config
    |--------------------------------------------------------------------------
    */
    'template_file' => env('L5_SWAGGER_TEMPLATE_FILE', 'config/swaggertemplate.json'),
